"""The single structural pass: scopes, calls, loops and gradient contexts.

Split out of `ir/scopes.py`, which re-exports `walk_module` and
`callee_construct`. Loop *kind* classification is a separate pass
(`scopes_loops`) because it needs the binding table.
"""
...
__all__ = ["walk_module", "callee_construct"]
