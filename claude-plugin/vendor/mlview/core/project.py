...
from .project_resolve import (ScopeResolution, _with_descendants,  # noqa: F401
                              resolve_scope)
from .selectors import (CONCERN_ALIASES, CONCERN_LABELS, CONCERNS,  # noqa: F401
                        DEFAULT_DEPTH, MAX_DEPTH, SCOPE_KINDS, SCOPE_SPELLINGS,
                        Scope, ScopeError, parse_scope)
