"""Typed edges: `data`, `call`, `control`, `config` - and the entrypoint rank.
...
from . import hooks
from .build_roles import LOOP_BACK_LABEL as _LOOP_BACK_LABEL
...
class EdgesMixin:
    """`GraphBuilder`'s edge half - mixed in, never instantiated alone."""
