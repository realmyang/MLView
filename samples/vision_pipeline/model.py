...
Planted here: MLV702 (the blocks live in a plain Python list) and MLV401
(forward returns probabilities, while train.py uses CrossEntropyLoss).
"""
...
class SmallCNN(nn.Module):
    ...
    def __init__(self, classes: int = NUM_CLASSES, width: int = WIDTH,
        ...
        self.blocks = [ConvBlock(width, width) for _ in range(depth)]
