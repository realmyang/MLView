...
class PairedPatchDataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        if self.train:
            ...
            # DEFECT: the flip and the rotation are applied to the LOW
            # member only, so every augmented pair is geometrically
            # inconsistent and the generator is trained to un-mirror.
