...
Defective twin of `nlp_distil_bert/losses.py`: the student's logits are turned
into probabilities before they reach CrossEntropyLoss, so the hard term is a
log-softmax of a softmax.
"""
...
class DistillationLoss(nn.Module):
    ...
    def forward(self, student_logits, teacher_logits, labels):
        ...
        hard_loss = self.hard(probabilities, labels)
