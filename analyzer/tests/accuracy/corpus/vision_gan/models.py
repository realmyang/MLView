"""DCGAN generator and discriminator, plus the WGAN-GP critic.

The discriminator returns raw scores. The DCGAN objective is
`BCEWithLogitsLoss`, which applies the sigmoid internally; the WGAN critic has
no probability interpretation at all, so it is never activated either.
"""
...
class Discriminator(nn.Module):
    """A DCGAN discriminator that returns one logit per image."""
