"""A single-stage detector: CSP-ish backbone, FPN neck, shared heads.

Both heads return raw logits. The classification branch is scored with
`BCEWithLogitsLoss`, which applies the sigmoid itself, so nothing here
activates the class output.
"""
