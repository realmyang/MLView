"""The LightningDataModule for a folder-of-images classification task.

`setup` builds the three datasets; the three dataloader hooks serve them. The
augmented pipeline is bound to the training dataset only.
"""
...
class ImageDataModule(pl.LightningDataModule):
    """Three ImageFolder splits, two transform pipelines, three loaders."""
