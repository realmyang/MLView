...
| [`../evals/workflow/development/native-artifacts/README.md`](../evals/workflow/development/native-artifacts/README.md) | Nine byte-identical initial native outputs and a challenged child revision, with frozen source provenance and pending human semantic review |
