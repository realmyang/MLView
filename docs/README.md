...
| [`demo-logs/2026-09-17-publication-desktop-retry.md`](demo-logs/2026-09-17-publication-desktop-retry.md) | Successful publication, Windows CI path assertions, intermittent desktop attachment and the immediate-navigation selection race |
...
| [`../evals/workflow/development/native-artifacts/README.md`](../evals/workflow/development/native-artifacts/README.md) | Twelve byte-identical initial native outputs and a challenged child revision, with frozen source provenance and pending human semantic review |
